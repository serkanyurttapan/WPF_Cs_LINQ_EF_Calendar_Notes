C# Language project showing MVVM pattern in simple project: Calendar with Notes. The project enable User to store and modify notes or messages according to the calendar dates.
